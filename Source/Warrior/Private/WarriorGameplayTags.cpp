...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_SwtichTarget_Left, "Player.Event.SwtichTarget.Left");
	UE_DEFINE_GAMEPLAY_TAG(Player_Event_SwtichTarget_Right, "Player.Event.SwtichTarget.Right");
